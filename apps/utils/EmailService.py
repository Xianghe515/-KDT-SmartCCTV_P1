...
class EmailService:
    ...
    @staticmethod
    def send_alert(recipient_email, subject, body):
        def send():
            try:
...
def send_alert_without_app_context(recipient_email, subject, body):
    try:
    ...
    # # 이메일 전송 호출
    # send_alert_without_app_context('xianghe515@naver.com', 'Test Subject', 'Test Body')